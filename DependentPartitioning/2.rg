...
task main()
  ...
  --
  -- In this example, we first partition the nodes into a number
  -- of subregions.
  --
  ...
  --
  -- Partition the edges region based on the node partition.  Specifically,
  -- for each subregion of nodes, collect all the edges that have one of the
  -- nodes in that subregion as its source.
  --
