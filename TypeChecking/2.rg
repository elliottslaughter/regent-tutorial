...
--
--  This cast should work, but region type casts are currently unimplemented.
--
     edge_update(private_nodes_partition[color], [region(Edge(private_nodes_partition[color]))] (private_edges_partition[color]))
   end
end
